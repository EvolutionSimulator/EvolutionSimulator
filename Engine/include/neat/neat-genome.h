 ...
 */
  class Genome {
   ...
   private:
    ...
    std::vector<BrainModule> AvailableModules = {BrainModule(3, 0, 1) }; //Geolocation Module and Pheromone Module
    //To add more modules you also have to change the think function of the creature. //BrainModule(1, 1, 2, true)
