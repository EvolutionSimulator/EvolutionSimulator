...
Creature::Creature(neat::Genome genome, Mutable mutables, double x_coord,
                   double y_coord, int generation)
...
void Creature::Bite(Food *food) {
  ...
  double food_to_eat =
      std::sqrt(std::min(pow(bite_strength_, 2), available_space));
