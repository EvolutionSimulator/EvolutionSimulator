 ...
 *
 * @details This file provides a collection of utility functions used for collision detection and distance
 *          calculations within a simulation environment. These functions are critical for determining interactions
 *          between various entities within the simulation, such as collisions between circles (representing objects or agents)
 *          and line segments (potentially representing boundaries or obstacles).
 */
 ...
 *
 * @details Computes the straight-line distance between two points in a 2D plane using the Euclidean distance formula.
 *
 ...
 *
 * @details Determines the minimum distance from a given point to a line segment, not an infinite line.
 *          If the perpendicular from the point to the line falls outside the line segment, the distance is
 *          calculated from the point to the nearest endpoint of the segment.
 *
 * @param point The point for which the distance to the line segment is to be calculated.
...
/*!
 * @brief Determines if two circles collide or are within a certain tolerance of each other.
 *
 * @details Checks for collision or proximity between two circles, taking into account a specified tolerance.
 *          The circles are considered to be colliding or in proximity if the distance between their centers
 *          is less than or equal to the sum of their radii plus the tolerance.
 *
 * @param tolerance The tolerance within which two circles are considered to be colliding or in proximity.
 ...
 *
 * @return true if the circles collide or are within the specified tolerance, false otherwise.
 */
...
/*!
 * @brief Determines if a circle collides with or is within a certain tolerance of a line segment.
 *
 * @details Checks for collision or proximity between a circle and a line segment, considering a specified tolerance.
 *          The circle and line segment are considered to be colliding or in proximity if the shortest distance
 *          from the circle's center to the line segment is less than or equal to the circle's radius plus the tolerance.
 *
 * @param tolerance The tolerance within which the circle and line segment are considered to be colliding or in proximity.
 * @param center The center of the circle.
 * @param radius The radius of the circle.
 * @param linePoint1 The first endpoint of the line segment.
 * @param linePoint2 The second endpoint of the line segment.
 *
 * @return true if the circle and line segment collide or are within the specified tolerance, false otherwise.
 */
