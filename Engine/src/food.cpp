 ...
 *
 * @details Initializes Food with a random size and calculates its nutritional value.
 */
Food::Food()
 ...
 *
 * @details The plant's nutritional value increases with photosynthesis and decreases with age.
 */
 ...
 *
 * @details The nutritional value of the Meat decreases over time, and it becomes Dead when it reaches zero.
 */
void Meat::Rot()
{
